...
(function() {
      ...
      return {
        ...
        compile: function dirPaginationCompileFn(tElement, tAttrs) {
          ...
          return function dirPaginationLinkFn(scope, element, attrs) {
            ...
            var paginationId =
              $parse(attrs.paginationId)(scope) ||
              attrs.paginationId ||
              DEFAULT_ID;
            paginationService.registerInstance(paginationId);

            var repeatExpression;
            var idDefinedInFilter = !!expression.match(
              /(\|\s*itemsPerPage\s*:[^|]*:[^|]*)/,
            );
  ...
  module.directive("dirPaginationControls", [
    "paginationService",
    "paginationTemplate",
    function(paginationService, paginationTemplate) {
      ...
      return {
        ...
        link: function dirPaginationControlsLinkFn(scope, element, attrs) {
          ...
          var paginationId =
            scope.paginationId || attrs.paginationId || DEFAULT_ID;
      ...
      return function(collection, itemsPerPage, paginationId) {
        ...
        if (collection instanceof Array) {
          ...
          if (paginationService.isAsyncMode(paginationId)) {
            ...
            start =
              (paginationService.getCurrentPage(paginationId) - 1) *
              itemsPerPage;
          }
